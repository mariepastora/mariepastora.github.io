console.log("Type the Konami code on your keyboard! I mean, click outside of the console first, anywhere on the page that's not a link. And then the Konami code is up,up,down,down,left,right,left,right,b,a ")
