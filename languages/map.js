...
function responsivefy(svg_map) {
  ...
  var width = parseInt(svg_map.style('width'))

  var height = parseInt(svg_map.style('height'))
...
var colorScale = d3
  ...
  .range([
    'rgba(237,248,251,0.9)',
    'rgba(191,211,230,0.9)',
    'rgba(158,188,218,0.9)',
    'rgba(140,150,198,0.9)',
    'rgba(136,86,167,0.9)',
    'rgba(129,15,124, 0.9)'
  ])
...
var tip = d3
  ...
  .html(function(d) {
    return (
      d.properties.all_simplified_Geography +
      ': ' +
      d.properties.census_tracts_with_ldi_ldi.toFixed(3)
    )
  })
