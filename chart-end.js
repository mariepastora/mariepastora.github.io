...
d3.csv("NUMBERS.csv", function(d, i, columns) {
...
// Sorting data by production per state
...
// Appending bars of stacked barchart
...
// Handling mouseover events and tips
...
// When clicking on "MWH generated" button
// It's exactly the same one as above
// Which is super sub-optimal
...
function absolute(){
  ...
  svg.append("g")
    ...
    .append("text")
      ...
      .attr("font-weight", "bold")
      .attr("text-anchor", "start")
      .text("Electricity generated per State (MWH)")
